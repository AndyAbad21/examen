...
a persistence unit "demo68PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demo68/pom.xml":
...
artifact ("demo68.war") is already built. You can build
